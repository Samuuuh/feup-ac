...
def simple():
    train = pd.read_csv('./preprocessing/loan_train.csv',
                        usecols=['loan_id', 'account_id', 'loan_year', 'loan_month', 'loan_day', 'amount', 'duration',
                                 'payments', 'status'], sep=';')
    ...
    test = pd.read_csv('./preprocessing/loan_test.csv',
                       usecols=['loan_id', 'account_id', 'loan_year', 'loan_month', 'loan_day', 'amount', 'duration',
                                'payments'], sep=';')
