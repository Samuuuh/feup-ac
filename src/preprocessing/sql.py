...
connection = sqlite3.connect('ac-v04.db')
...
contents = csv.reader(open('./raw/account.csv'), delimiter=';')
...
contents = csv.reader(open('./raw/card_comp.csv'), delimiter=';')
...
contents = csv.reader(open('./raw/client.csv'), delimiter=';')
...
contents = csv.reader(open('./raw/disp.csv'), delimiter=';')
...
contents = csv.reader(open('./raw/district.csv'), delimiter=';')
...
contents = csv.reader(open('./raw/loan_dev.csv'), delimiter=';')
...
contents = csv.reader(open('./raw/trans_dev.csv'), delimiter=';')
